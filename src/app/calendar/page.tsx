...
export default async function CalendarPage() {
    ...
    return (
      <main className="mx-auto flex min-h-screen w-full max-w-4xl items-center px-6 py-10">
        <section className="w-full rounded-2xl border border-amber-200 bg-amber-50 p-8">
          ...
          <p className="mt-3 leading-7 text-amber-900">Sua identidade foi reconhecida, mas nenhum perfil aprovado concede consulta à agenda. Solicite ao administrador a atribuição formal do perfil adequado.</p>
        </section>
      </main>
    );
  }
  ...
  return (
    <main className="mx-auto w-full max-w-[1500px] px-4 py-5 sm:px-6 lg:px-8 lg:py-7">
      <PageHeader eyebrow="Comercial" icon="calendar" subtitle="Prazos de editais, entregas de proposta e compromissos de equipe em um único lugar." title="Agenda" variant="executive" />
