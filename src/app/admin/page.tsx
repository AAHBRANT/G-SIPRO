...
export default async function AdminPage() {
  ...
  const now = new Date();
  const [users, permissions, departments, failures, pendingSupport, accessRequests] = await Promise.all([
